...
def send_n_per_2_email(sender_number,receiver_number,):
    ...
    send_email_with_attachment(sender_email, receiver_email, subject,body,file_path )


def receive_n_per_2_email(receiver_number):
